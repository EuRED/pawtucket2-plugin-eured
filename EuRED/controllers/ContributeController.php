 ...
 */
	...
	require_once(__CA_LIB_DIR__."/ca/BasePluginController.php");
 	...
 	class ContributeController extends BasePluginController {
 		# -------------------------------------------------------
 		...
 		public function Index() {
            ...
            if (isset($_POST) && $_POST) {$this->view->setVar('intro_text', "<h2>Thanks for your contribution !</h2>"); }
        ...
        public function Thanks() {
            $this->view->setVar('result', json_encode($_POST));
            $this->render("thanks_html.php");
        }
 	}
 ?>