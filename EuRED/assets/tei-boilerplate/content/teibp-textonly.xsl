...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="xsl tei xd eg fn #default">
	...
	-->
	<xsl:param name="filePrefix" select="'/app/plugins/EuRED/assets/tei-boilerplate/'"/>
	
	<xsl:param name="teibpCSS" select="concat($filePrefix,'/css/teibp-textonly.css')"/>
	<xsl:param name="customCSS" select="concat($filePrefix,'/css/custom-textonly.css')"/>
